#!/usr/bin/env python3
"""
Fetch energy consumption data from Energy Data Service API
...
DATA_DIR = "data"
OUTPUT_PARQUET = os.path.join(DATA_DIR, "consumption_data.parquet")
OUTPUT_CSV = os.path.join(DATA_DIR, "consumption_data.csv")
...
def fetch_all_consumption_data(start_date, end_date, use_pagination=True):
    ...
    print(f"Dataset: ConsumptionConsumerCategoryHour")
