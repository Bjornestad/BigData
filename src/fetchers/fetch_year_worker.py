...
def fetch_dmi_year_data(year, stations, parameters):
...
def fetch_energy_year_data(year):
...
def main():
    ...
    try:
        dmi_records = fetch_dmi_year_data(year, SYNOP_STATIONS, ALL_PARAMETERS)
    ...
    try:
        energy_records = fetch_energy_year_data(year)
